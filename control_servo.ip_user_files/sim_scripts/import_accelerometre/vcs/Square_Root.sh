...
#
# Script generated by Vivado on Tue Nov 28 00:18:38 +0100 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Square_Root.sh
...
#
# Usage        : Square_Root.sh
#                Square_Root.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Square_Root.sh [-reset_run]
#                Square_Root.sh [-reset_log]
#                Square_Root.sh [-help]
#
...
#                script (type 'Square_Root.sh -help' for more information).
#
...
# script info
echo -e "Square_Root.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Square_Root.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/K4des/OneDrive/Bureau/control_servo/control_servo.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key Square_Root_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Square_Root_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Square_Root.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Square_Root.sh [-help]\n\
Usage: Square_Root.sh [-step]\n\
Usage: Square_Root.sh [-lib_map_path]\n\
Usage: Square_Root.sh [-reset_run]\n\
Usage: Square_Root.sh [-reset_log]\n\
Usage: Square_Root.sh [-keep_index]\n\
Usage: Square_Root.sh [-noclean_files]\n\n\
