...
design_libs_elab="-libname secureip"

# set design libraries
design_libs=(simprims_ver)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/K4des/OneDrive/Bureau/control_servo/control_servo.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Square_Root_sc.so .tmp_log xcelium_lib waves.shm c.obj)
