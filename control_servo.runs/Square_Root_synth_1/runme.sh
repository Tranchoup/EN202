...
HD_PWD='C:/Users/K4des/OneDrive/Bureau/control_servo/control_servo.runs/Square_Root_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Square_Root.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Square_Root.tcl
